...
Route::group(['namespace' => 'api\v4', 'prefix' => 'v4', 'middleware' => ['api_lang']], function () {
    ...
    Route::post('payments/orders/{transactionId}', [App\Http\Controllers\PesapalController::class, 'pesapalWebhook']);
    ...
    Route::get('subscription', 'GeneralController@subscription');
