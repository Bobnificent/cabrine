                            ...
                            @foreach (json_decode($language) as $lang)
                                <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea name="description[]" class="summernote textarea form-control editor-textarea">{{ old('details') }}</textarea>
...
@push('script')
    ...
    <script>
        function check() {
            Swal.fire({
                ...
                if (result.value) {
                    // Update Summernote fields before submission
    ...
    <script src="{{ asset('public/assets/back-end/plugins/summernote/summernote.min.js') }}"></script>
    <script>
        $(document).ready(function() {
