                            ...
                            <div class="mb-30">
                                <ul class="option-select-btn flex-wrap gap-3">
                                    ...
                                    @if ($digital_payment['status']==1)
                                        ...
                                        @if($pesapal['status'])
                                        <li>
                                            <form action="{{route('pay-pesapal')}}" method="post" id="payment-form" class="digital_payment d--none">
                                                @csrf
                                                <label>
                                                    <button class="payment-method border-0 d-flex align-iems-center gap-3">
                                                        <img width="90" src="{{ theme_asset('assets/img/payment/pesapal.svg') }}" class="dark-support" alt="">
                                                    </button>
                                                </label>
                                            </form>
                                        </li>
